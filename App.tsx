...
const App: React.FC = () => {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      setError(err.message || "Đã xảy ra lỗi khi tạo nội dung. Vui lòng kiểm tra API Key và thử lại.");
    } finally {
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="bg-blue-50 border border-blue-100 rounded-xl p-5">
              ...
              <ul className="text-sm text-blue-700 space-y-1.5 list-disc list-inside">
                <li><strong>Chế độ Tạo bài tập:</strong> Nhập chủ đề, hệ thống sẽ tạo bộ đề ôn luyện chuẩn cấu trúc.</li>
                <li><strong>Chế độ Soạn Giáo án NLS:</strong> Nhập tên bài học và <strong>dán nội dung giáo án gốc</strong> vào ô "Nội dung giáo án". AI sẽ phân tích và tích hợp các năng lực số (NLS) phù hợp vào giáo án.</li>
                <li>Hệ thống tự động nhận diện tất cả môn học và khối lớp.</li>
              </ul>
            </div>
          </div>
          ...
          <div className="lg:col-span-8">
            ...
            {generatedContent || isGenerating ? (
              ...
              <div className="h-[400px] flex flex-col items-center justify-center text-slate-400 border-2 border-dashed border-slate-200 rounded-xl bg-slate-50/50">
                ...
                <p className="text-sm">Hãy cấu hình và nhấn nút tạo để bắt đầu</p>
              </div>
            )}
          </div>
        </div>
